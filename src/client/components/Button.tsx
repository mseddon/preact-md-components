...
export class Button extends Component<{disabled?: boolean, type?: "accent" | "flat", onClick: () => void, extraClasses?: string}, {}> {
    render() {
        return <div class={"md-button" + (this.props.extraClasses ? " "+this.props.extraClasses : "")} onClick={() => this.props.disabled ? null : this.props.onClick()}>{ this.props.disabled ? null : <RippleBox extraClasses={(this.props.type && this.props.type == "flat") ? "dark-ripple": ""}/> }
